...
const BookUs = () => {
  return (
    <div className="relative w-full">
      <div className="absolute inset-0 bg-white md:bg-[#020223] md:h-[40%] md:top-1/2 z-0" />

      <div className="relative z-10 order-1 md:order-2 flex flex-col items-center justify-center pb-30 md:pb-25 md:px-8">
        <div className="md:bg-[#538FDF] md:flex justify-center items-center md:w-fit md:p-5 rounded-2xl">
          ...
          <div className="bg-white md:bg-[#538FDF] mw-full p-5 md:w-1/2 md:p-0">
