...
const Footer = () => {
  return (
    <div className="flex h-[80%] justify-center items-center flex-col  p-10 rounded-lg md:justify-between md:space-x-20 md:flex-row md:rounded-xl m-5 bg-[#538FDF]">
      <img src={footerLogo} alt="Footer Logo" className="w-80 h-30" />
       <div className="flex flex-col items-center text-center  space-y-2 md:space-y-0 justify-center md:flex-row md:justify-evenly md:items-start md:space-x-20 w-full mt-6">
